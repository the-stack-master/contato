...
export default function MoreInfoSection({
  ...
  return (
    <section className="py-40 relative overflow-hidden bg-white">
        ...
        >
          {paragraphs.map((para, index) => (
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute -left-4 top-0 w-1 h-16 bg-gradient-to-b from-blue-500 to-transparent" />
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-500/5 rounded-full blur-3xl -z-10" />
