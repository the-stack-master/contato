      ...
      <section className="relative pt-5 pb-5 px-6">
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-[#f15A24]/10 to-orange-100/50 px-6 py-3 rounded-full mb-8">
            ...
            <span className="text-[#f15A24] font-semibold">Our Story</span>
          </div>
          ...
          {/* <p className="text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
            We're on a mission to transform professional networking by making
            meaningful connections accessible, intelligent, and impactful for
            everyone.
          </p> */}
        </div>
      </section>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-md text-gray-600 leading-relaxed mb-6">
                  ...
                  connections, too many missed opportunities, and too little
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-[#f15A24]/10 to-orange-100/50 px-6 py-3 rounded-full mb-8">
              ...
              <span className="text-[#f15A24] font-semibold">Our Team</span>
            </div>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Our diverse team of innovators, engineers, and visionaries are
              united by one goal: making professional networking work for
              everyone.
            </p>
          </div>
        ...
        >
          <div className="mb-6">
            ...
            <p className="text-md text-white/85 max-w-xl mx-auto mb-2">
              For career opportunities and inquiries, please get in touch with
              our Human Resources team.
            </p>
            <p className="text-sm text-white/75 mb-6">
              Email:{" "}
              <a
                href="mailto:hr@connecto.com"
          ...
          <div className="flex justify-center">
            <Button
              ...
              onClick={() => window.open("mailto:hr@connecto.com", "_blank")}
            >
